...
new_data <- read_excel("Annual_Data_Region4.xlsx")
...
grand_total_mw <- sum(fleet_share_long$mw_sum) + 140170000
  # Add total renewable generation for 2022 above
  # Note all regions will not add up to national because of generation in AK,
  # HI, and territories not included in regions
    # National = 888450000
    # Region 1 = 310809200
    # Region 2 = 276180000
    # Region 3 = 155644000
